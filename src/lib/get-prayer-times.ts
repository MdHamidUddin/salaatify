...
export async function getTimingsByCity(geolocation: {city: string; country_name: string}) {
  try {
    console.log(
      `Fetching prayer timings for city: ${geolocation.city}, country: ${geolocation.country_name}`,
    )
